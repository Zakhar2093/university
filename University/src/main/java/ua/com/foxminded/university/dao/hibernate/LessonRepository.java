...
// todo common method
    ...
    public void removeGroupFromLesson(Integer lessonId) {
        ...
        Query query = session.createQuery("UPDATE Lesson L SET L.group = null WHERE L.lessonId =: lessonId");
        query.setParameter("lessonId", lessonId);
        query.executeUpdate();
        ...
        logger.debug("removed Group from group Lesson with id = {} ", lessonId);
    }
    ...
    public void removeRoomFromLesson(Integer lessonId) {
        ...
        Query query = session.createQuery("UPDATE Lesson L SET L.room = null WHERE L.lessonId =: lessonId");
        query.setParameter("lessonId", lessonId);
        query.executeUpdate();
        ...
        logger.debug("removed Room from group Lesson with id = {} ", lessonId);
    }
    ...
    public void removeTeacherFromLesson(Integer lessonId) {
        ...
        Query query = session.createQuery("UPDATE Lesson L SET L.teacher = null WHERE L.lessonId =: lessonId");
        query.setParameter("lessonId", lessonId);
        query.executeUpdate();
        ...
        logger.debug("removed Teacher from group Lesson with id = {} ", lessonId);
    }
    ...
    @Override
    public List<Lesson> getLessonsByRoomId(Integer groupId) {
        return null;
    }

    @Override
    public List<Lesson> getLessonsByTeacherId(Integer groupId) {
        return null;
    }
}